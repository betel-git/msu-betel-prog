...
6. Большинство тестов было взято из данного файла: http://v-dinsky.info/2024/files-1/require1_2_2.pdf, что особенно упрощает проверку задач на обратные матрицы (все ответы правильные, я проверил).